...
class TestLegalMove(ut.TestCase):
    ...
    def test_legal_movement_rook(self):
        ...
        legal_check_1 = legal_movement(self.chess_board_scattered, 1, 7, 1, 1, None, True)
        ...
        legal_check_2 = legal_movement(self.chess_board_scattered, 1, 1, 1, 7, None, True)
    ...
    def test_legal_movement_bishop(self):
        ...
        legal_check_1 = legal_movement(self.chess_board_scattered, 2, 2, 0, 0, None, True)
        legal_check_2 = legal_movement(self.chess_board_scattered, 2, 2, 0, 4, None, True)
    ...
    def test_legal_movement_queen(self):
        ...
        legal_check_1 = legal_movement(self.chess_board_scattered, 1, 3, 1, 0, None, True)
        legal_check_2 = legal_movement(self.chess_board_scattered, 1, 3, 0, 4, None, True)
    ...
    def test_legal_movement_en_passant_wp(self):
        ...
        legal_check_1 = legal_movement(self.chess_board_starting, 3, 4, 2, 3, previous, True)
    ...
    def test_legal_movement_en_passant_bp(self):
        ...
        legal_check_1 = legal_movement(self.chess_board_starting, 4, 4, 5, 5, previous, True)
        ...
        legal_check_2 = legal_movement(self.chess_board_starting, 4, 4, 5, 5, previous_2, True)
    ...
    def test_legal_movement_self_check(self):
        ...
        legal_check_1 = legal_movement(self.chess_board_starting, 5, 4, 4, 5, None, False)
